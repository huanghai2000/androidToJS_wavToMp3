...
#include "lame.h"
#include "cn_qtone_yzt_util_LameUtil.h"
...
void Java_cn_qtone_yzt_util_LameUtil_initEncoder(JNIEnv *env,
...
void Java_cn_qtone_yzt_util_LameUtil_encodeFile(JNIEnv *env,
